...
=end
 ...
 ########################################################################################################################
  ...
  #member = membro a tutti gli effetti, quindi come tutti gli altri avrà l'id (a parte index e create e new che ovviamente non possono averlo)
  resources :any do
    member do
      get 'added'
      post 'oddio'
  ...
  # in questo caso aggiunge l'id MA se scrivo 'resource :any' l'id nelle rotte non le vedo più
=begin

  added_any     GET    /any/:id/added(.:format)                           any#added
  oddio_any     POST   /any/:id/oddio(.:format)                           any#oddio
  any_index     GET    /any(.:format)                                     any#index
                POST   /any(.:format)                                     any#create
  new_any       GET    /any/new(.:format)                                 any#new
  edit_any      GET    /any/:id/edit(.:format)                            any#edit
  any           GET    /any/:id(.:format)                                 any#show
                PATCH  /any/:id(.:format)                                 any#update
                PUT    /any/:id(.:format)                                 any#update
                DELETE /any/:id(.:format)                                 any#destroy
=end
  ...
  # collection= è una lista, quindi come la index non può avere l'id.
  ...
  # essendo una collection non gli serve l'id, quindi nella rotta non compare. Quindi
  # se metto member, alla rotta aggiunta gli mette l'id
  # se metto collection, alla rotta aggiunta NON gli mette l'id

  ########################################################################################################################

  # Aggiunge una rotta new alternativa.
...
=begin
  added_new_any3 GET    /any3/new/added(.:format)                          any3#added
  new_any3       GET    /any3/new(.:format)                                any3#new
=end
...
=begin
  added_any2_index     GET    /any2/added(.:format)                              any2#added
  any2_index           GET    /any2(.:format)                                    any2#index
                       POST   /any2(.:format)                                    any2#create
  new_any2             GET    /any2/new(.:format)                                any2#new
  edit_any2            GET    /any2/:id/edit(.:format)                           any2#edit
  any2                 GET    /any2/:id(.:format)                                any2#show
                       PATCH  /any2/:id(.:format)                                any2#update
                       PUT    /any2/:id(.:format)                                any2#update
                       DELETE /any2/:id(.:format)                                any2#destroy
=end
