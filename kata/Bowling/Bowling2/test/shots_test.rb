...
class ShotsTest < Test::Unit::TestCase
  ...
  def test_third_frame_shots_when_strike_in_first_and_second_frame
    ...
    assert_equal [10, nil, 10, nil, 1], shots.at_frames(0)
    assert_equal [10, nil, 1, 2], shots.at_frames(1)
    assert_equal [1, 2], shots.at_frames(2)
  end
